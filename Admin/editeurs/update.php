...
<body id="page-top">
  ...
  <input type="text" class="form-control" id="denomination" name="denomination" value="<?= $editeurs["denomination"]?>">
</div>

<div class="mb-3">
<label for="siret" class="form-label">Siret :</label>
  <input type="text" class="form-control" id="siret" name="siret" value="<?= $editeurs["siret"]?>">
</div>

<div class="mb-3">
<label for="adresse" class="form-label">Adresse :</label>
  <input type="text" class="form-control" id="adresse" name="adresse" value="<?= $editeurs["adresse"]?>">
</div>

<div class="mb-3">
<label for="ville" class="form-label">Ville :</label>
  <input type="text" class="form-control" id="ville" name="ville" value="<?= $editeurs["ville"]?>">
</div>

<div class="mb-3">
<label for="mail" class="form-label">Code Postal :</label>
  <input type="text" class="form-control" id="code_postal" name="code_postal" value="<?=$editeurs["code_postal"]?>">
</div>

<div class="mb-3">
<label for="mail" class="form-label">E-Mail :</label>
  <input type="mail" class="form-control" id="mail" name="mail" value="<?=$editeurs["mail"]?>">
</div>

<div class="mb-3">
<label for="numero_tel" class="form-label">Numéro Téléphone : </label>
  <input type="text" class="form-control" id="numero_tel" name="numero_tel" value="<?= $editeurs["numero_tel"]?>">
</div>

<input type="submit" name="btn_modifier_editeur" class="btn btn-primary" value="Modifier">
<input type="submit" name="btn_effacer_editeur" class="btn btn-warning" value="Supprimer">
