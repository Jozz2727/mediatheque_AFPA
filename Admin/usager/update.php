...
<body id="page-top">
  ...
  <input type="text" class="form-control" id="nom" name="nom" value="<?= $usagers["nom"]?>">
</div>

<div class="mb-3">
<label for="prenom" class="form-label">Prenom :</label>
  <input type="text" class="form-control" id="prenom" name="prenom" value="<?= $usagers["prenom"]?>">
</div>

<div class="mb-3">
<label for="adresse" class="form-label">Adresse :</label>
  <input type="text" class="form-control" id="adresse" name="adresse" value="<?= $usagers["adresse"]?>">
</div>

<div class="mb-3">
<label for="ville" class="form-label">Ville :</label>
  <input type="text" class="form-control" id="ville" name="ville" value="<?= $usagers["ville"]?>">
</div>

<div class="mb-3">
<label for="code_postal" class="form-label">Code Postal :</label>
  <input type="text" class="form-control" id="code_postal" name="code_postal" value="<?=$usagers["code_postal"]?>">
</div>

<div class="mb-3">
<label for="mail" class="form-label">E-Mail : </label>
  <input type="mail" class="form-control" id="mail" name="mail" value="<?= $usagers["mail"]?>">
</div>

<input type="submit" name="btn_modifier_usager" class="btn btn-primary" value="Modifier">
<input type="submit" name="btn_effacer_usager" class="btn btn-warning" value="Supprimer">
</form>
